...
SILVER_DIM_DATE = DeltaTableDef(
    layer="silver",
    table_name="silver_dim_date",
    relative_path="silver/dim_date",
    description="Calendar dimension for time-series aggregation. Contains business day, holiday flags.",
    partition_by=["year"],
    zorder_by=["full_date"],
    primary_keys=["date_key"],
    enable_cdf=False,
    columns=[
        ColumnDef("date_key",        "IntegerType",   False, "Format YYYYMMDD (e.g. 20260511)"),
        ColumnDef("full_date",       "DateType",      False, "Actual Date object"),
        ColumnDef("year",            "IntegerType",   False),
        ColumnDef("quarter",         "IntegerType",   False),
        ColumnDef("month",           "IntegerType",   False),
        ColumnDef("day",             "IntegerType",   False),
        ColumnDef("day_of_week",     "IntegerType",   False, "1=Monday, 7=Sunday"),
        ColumnDef("is_weekend",      "BooleanType",   False),
        ColumnDef("is_business_day", "BooleanType",   False, "True if stock market is open"),
        ColumnDef("is_holiday",      "BooleanType",   False),
        ColumnDef("holiday_name",    "StringType",    True),
    ],
)
...
GOLD_FCT_BS_ASSETS = DeltaTableDef(
    ...
    description="Pivoted balance sheet assets. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ColumnDef("fact_key", "StringType", False, "SHA256(symbol+time_report_type+year+period)"),
        ColumnDef("company_key", "StringType", False, "Surrogate key for dim_company SCD link"),
        ColumnDef("symbol", "StringType", False),
        ColumnDef("time_report_type", "StringType", True),
        ColumnDef("financial_report_type", "StringType", True),
        ColumnDef("year", "StringType", True),
...
GOLD_FCT_BS_INTERBANK_PLACEMENTS = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_interbank_placements",
    relative_path="gold/fct_bs_interbank_placements",
    description="Pivoted balance sheet interbank placements details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ColumnDef("fact_key", "StringType", False),
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("placements_with_credit_institutions", "DecimalType", True),
        ColumnDef("loans_to_credit_institutions", "DecimalType", True),
        ColumnDef("ecl_allowance_loans_to_credit_institutions", "DecimalType", True),
        ColumnDef("interbank_placements_and_loans", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
...
GOLD_FCT_BS_TRADING_SECURITIES = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_trading_securities",
    relative_path="gold/fct_bs_trading_securities",
    description="Pivoted balance sheet trading securities details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("trading_securities_gross", "DecimalType", True),
        ColumnDef("allowance_trading_securities", "DecimalType", True),
        ColumnDef("trading_securities_net", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
...
GOLD_FCT_BS_LOANS_CUSTOMERS = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_loans_customers",
    relative_path="gold/fct_bs_loans_customers",
    description="Pivoted balance sheet loans to customers details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("loans_to_customers_gross", "DecimalType", True),
        ColumnDef("ecl_allowance_loans_to_customers", "DecimalType", True),
        ColumnDef("loans_to_customers_net", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
...
GOLD_FCT_BS_INVESTMENT_SECURITIES = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_investment_securities",
    relative_path="gold/fct_bs_investment_securities",
    description="Pivoted balance sheet investment securities details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("afs_securities", "DecimalType", True),
        ColumnDef("htm_securities", "DecimalType", True),
        ColumnDef("allowance_investment_securities", "DecimalType", True),
        ColumnDef("investment_securities_net", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
...
GOLD_FCT_BS_FIXED_ASSETS = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_fixed_assets",
    relative_path="gold/fct_bs_fixed_assets",
    description="Pivoted balance sheet fixed assets details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("tangible_fixed_assets_net", "DecimalType", True),
        ColumnDef("fixed_assets_cost", "DecimalType", True),
        ColumnDef("accumulated_depreciation", "DecimalType", True),
        ColumnDef("hierachy_of_fixed_assets_cost", "DecimalType", True),
        ColumnDef("hierachy_of_accumulated_depreciation", "DecimalType", True),
        ColumnDef("parent_of_accumulated_depreciation", "DecimalType", True),
        ColumnDef("parent_of_fixed_assets_cost", "DecimalType", True),
        ColumnDef("finance_lease_fixed_assets_net", "DecimalType", True),
        ColumnDef("intangible_assets_net", "DecimalType", True),
        ColumnDef("cip_construction_in_progress", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
)

GOLD_FCT_BS_OTHER_ASSETS = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_other_assets",
    relative_path="gold/fct_bs_other_assets",
    description="Pivoted balance sheet other assets details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("receivables_net", "DecimalType", True),
        ColumnDef("accrued_interest_and_fees_receivable", "DecimalType", True),
        ColumnDef("deferred_tax_assets", "DecimalType", True),
        ColumnDef("other_assets_gross", "DecimalType", True),
        ColumnDef("goodwill", "DecimalType", True),
        ColumnDef("allowance_other_on_balance_assets", "DecimalType", True),
        ColumnDef("hierachy_of_allowance_other_on_balance_assets", "DecimalType", True),
        ColumnDef("hierachy_of_goodwill", "DecimalType", True),
        ColumnDef("parent_of_goodwill", "DecimalType", True),
        ColumnDef("parent_of_allowance_other_on_balance_assets", "DecimalType", True),
        ColumnDef("other_assets_net", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
...
GOLD_FCT_BS_LIABILITIES = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_liabilities",
    relative_path="gold/fct_bs_liabilities",
    description="Pivoted balance sheet liabilities details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("due_to_government_and_central_bank", "DecimalType", True),
        ColumnDef("due_to_credit_institutions", "DecimalType", True),
        ColumnDef("deposits_from_credit_institutions", "DecimalType", True),
        ColumnDef("borrowings_from_credit_institutions", "DecimalType", True),
        ColumnDef("hierachy_of_deposits_from_credit_institutions", "DecimalType", True),
        ColumnDef("hierachy_of_borrowings_from_credit_institutions", "DecimalType", True),
        ColumnDef("parent_of_deposits_from_credit_institutions", "DecimalType", True),
        ColumnDef("parent_of_borrowings_from_credit_institutions", "DecimalType", True),
        ColumnDef("customer_deposits", "DecimalType", True),
        ColumnDef("derivatives_and_other_financial_liabilities", "DecimalType", True),
        ColumnDef("trust_and_investment_funds_bank_bearing_risk", "DecimalType", True),
        ColumnDef("debt_securities_issued", "DecimalType", True),
        ColumnDef("other_liabilities", "DecimalType", True),
        ColumnDef("accrued_interest_and_fees_payable", "DecimalType", True),
        ColumnDef("deferred_tax_liabilities", "DecimalType", True),
        ColumnDef("payables_and_other_liabilities", "DecimalType", True),
        ColumnDef("other_provisions", "DecimalType", True),
        ColumnDef("hierachy_of_accrued_interest_and_fees_payable", "DecimalType", True),
        ColumnDef("hierachy_of_deferred_tax_liabilities", "DecimalType", True),
        ColumnDef("hierachy_of_payables_and_other_liabilities", "DecimalType", True),
        ColumnDef("hierachy_of_other_provisions", "DecimalType", True),
        ColumnDef("parent_of_accrued_interest_and_fees_payable", "DecimalType", True),
        ColumnDef("parent_of_deferred_tax_liabilities", "DecimalType", True),
        ColumnDef("parent_of_payables_and_other_liabilities", "DecimalType", True),
        ColumnDef("parent_of_other_provisions", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
)

GOLD_FCT_BS_TOTAL_EQUITY = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_total_equity",
    relative_path="gold/fct_bs_total_equity",
    description="Pivoted balance sheet total equity details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("owners_equity_bank", "DecimalType", True),
        ColumnDef("bank_funds", "DecimalType", True),
        ColumnDef("fx_translation_differences", "DecimalType", True),
        ColumnDef("asset_revaluation_differences", "DecimalType", True),
        ColumnDef("retained_earnings_accumulated_losses", "DecimalType", True),
        ColumnDef("other_funds", "DecimalType", True),
        ColumnDef("non_controlling_interests", "DecimalType", True),
        ColumnDef("total_equity", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
)

GOLD_FCT_BS_OWNERS_EQUITY_BANK = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_bs_owners_equity_bank",
    relative_path="gold/fct_bs_owners_equity_bank",
    description="Pivoted balance sheet owners equity bank details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("paid_in_capital", "DecimalType", True),
        ColumnDef("capital_for_construction", "DecimalType", True),
        ColumnDef("share_premium", "DecimalType", True),
        ColumnDef("treasury_shares", "DecimalType", True),
        ColumnDef("preferred_shares", "DecimalType", True),
        ColumnDef("other_capital", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
)
...
GOLD_FCT_IS_CORE_INCOME = DeltaTableDef(
    ...
    columns=[
        ...
        ColumnDef("net_fee_and_commission_income", "DecimalType", True),
...
GOLD_FCT_IS_FINANCIAL_TRADING = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_is_financial_trading",
    relative_path="gold/fct_is_financial_trading",
    description="Pivoted income statement financial trading details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("net_fx_trading_income", "DecimalType", True),
        ColumnDef("net_trading_securities_income", "DecimalType", True),
        ColumnDef("net_investment_securities_income", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
)

GOLD_FCT_IS_OTHER_OPERATING = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_is_other_operating",
    relative_path="gold/fct_is_other_operating",
    description="Pivoted income statement other operation activities. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("net_other_operational_income", "DecimalType", True),
        ColumnDef("other_operating_income", "DecimalType", True),
        ColumnDef("other_operating_expenses", "DecimalType", True),
        ColumnDef("income_from_equity_investments", "DecimalType", True),
        ColumnDef("update_time", "TimestampType", True),
        ColumnDef("_updated_at", "TimestampType", False),
    ],
)

GOLD_FCT_IS_EXPENSE_PROFIT = DeltaTableDef(
    layer="gold",
    table_name="gold_fct_is_expense_profit",
    relative_path="gold/fct_is_expense_profit",
    description="Pivoted income statement expense and profit details. Power BI ready.",
    partition_by=["year"],
    zorder_by=["company_key", "year"],
    primary_keys=["fact_key"],
    enable_cdf=False,
    columns=[
        ...
        ColumnDef("year", "StringType", True),
        ColumnDef("period", "StringType", True),
        ColumnDef("operating_expenses", "DecimalType", True),
        ColumnDef("operating_profit_before_credit_provision", "DecimalType", True),
        ColumnDef("credit_risk_provision_expenses", "DecimalType", True),
        ColumnDef("profit_before_tax", "DecimalType", True),
        ColumnDef("corporate_income_tax_expense", "DecimalType", True),
        ColumnDef("current_income_tax_expense", "DecimalType", True),
        ColumnDef("deferred_income_tax_expense", "DecimalType", True),
        ColumnDef("profit_after_tax", "DecimalType", True),
        ColumnDef("minority_interests_and_preferred_dividends", "DecimalType", True),
...
ALL_GOLD_TABLES: Dict[str, DeltaTableDef] = {
    ...
    "fct_bs_interbank_placements": GOLD_FCT_BS_INTERBANK_PLACEMENTS,
    "fct_bs_trading_securities": GOLD_FCT_BS_TRADING_SECURITIES,
    "fct_bs_loans_customers": GOLD_FCT_BS_LOANS_CUSTOMERS,
    "fct_bs_investment_securities": GOLD_FCT_BS_INVESTMENT_SECURITIES,
    "fct_bs_fixed_assets": GOLD_FCT_BS_FIXED_ASSETS,
    "fct_bs_other_assets": GOLD_FCT_BS_OTHER_ASSETS,
    "fct_bs_liabilities": GOLD_FCT_BS_LIABILITIES,
    "fct_bs_total_equity": GOLD_FCT_BS_TOTAL_EQUITY,
    "fct_bs_owners_equity_bank": GOLD_FCT_BS_OWNERS_EQUITY_BANK,
    "fct_is_core_income":   GOLD_FCT_IS_CORE_INCOME,
    "fct_is_financial_trading": GOLD_FCT_IS_FINANCIAL_TRADING,
    "fct_is_other_operating": GOLD_FCT_IS_OTHER_OPERATING,
    "fct_is_expense_profit": GOLD_FCT_IS_EXPENSE_PROFIT,
